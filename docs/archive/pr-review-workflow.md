...
**Status:** superseded by [foreman-judgment-redesign](foreman-judgment-redesign.md) — PR-before-`done` and unconditional Verifier-on-`done` are no longer required; both are now Foreman's contextual choice.
