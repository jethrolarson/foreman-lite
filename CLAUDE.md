...
Make sure there's a paper trail in docs for research, decisions, bugs, ideas, specs and so on. You don't have to ask before creating but make sure justifications and shelf-life are clear so we can clean up the docs later.
