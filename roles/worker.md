...
- MUST NOT: signal after merely answering a question from a human attached to your pane. REASON: a signal routes to Foreman as task state; emit one only when lifecycle actually changed (plan ready, result ready, blocked), regardless of who prompted the turn.
